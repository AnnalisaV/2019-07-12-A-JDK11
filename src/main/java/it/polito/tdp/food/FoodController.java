...
public class FoodController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	Integer portion; 
    	try {
    	portion= Integer.parseInt(this.txtPorzioni.getText());
    	}
    ...
    void doCalorie(ActionEvent event) {
    	...
    	List<FoodCalories> lista= this.model.cibiConnessiCalorieMax(this.boxFood.getValue()); 
    	for (int i=0; i<5 && i<lista.size(); i++) {
    		txtResult.appendText(lista.get(i).toString()+"\n");
    ...
    void doSimula(ActionEvent event) {
    	...
    	try {
    		...
    		txtResult.appendText("ERRORE Formato numerico\n");
    		return; 
    	}
    	
    	txtResult.appendText(this.model.simula(this.boxFood.getValue(),k));
    }
